...
public class SessionTestData implements ItemData {
    ...
    public SessionTestData(PhotonIMSession session) {
    ...
    private SessionTestData(Builder builder) {
...
//        sessionExtra = builder.sessionExtra;
    ...
    public TestSendBean getTestSendBean() {
        return testSendBean;
    }

    public void setTestSendBean(TestSendBean testSendBean) {
...
//        photonIMSession.extra = extra == null ? new Gson().toJson(sessionExtra) : extra;
    ...
    public static final class Builder {
        ...
        private long orderId;
        private String draft;
        private int itemType = Constants.ITEM_TYPE_MSG_TEST;
        private int position;
        private boolean showAtTip;
        private SpannableString atMsg;
...
//        }
        ...
        public SessionTestData build() {
            return new SessionTestData(this);
        }
