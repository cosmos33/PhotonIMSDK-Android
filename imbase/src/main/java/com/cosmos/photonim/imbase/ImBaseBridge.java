...
public class ImBaseBridge {
    ...
    public void leaveRoom(String rId, IChatRoomModel.ChatRoomListener listener) {
        ...
        businessListener.leaveRoom(rId, listener);
    }

    public void onRoomInfoClick(ChatRoomActivity chatRoomActivity, String roomId, String rName) {
        if (businessListener != null) {
            businessListener.onRoomInfoClick(chatRoomActivity, roomId, rName);
        }
    }
    ...
    public void upLoadMMfileLog(){
        if(SharedPrefUtil.getServerType(0) == 0){
            PhotonIMClient.getInstance().setPhotonIMServerType(PhotonIMClient.IM_SERVER_TYPE_OVERSEAS);
            SharedPrefUtil.saveServerType(1);
        }else{
            PhotonIMClient.getInstance().setPhotonIMServerType(PhotonIMClient.IM_SERVER_TYPE_INLAND);
            SharedPrefUtil.saveServerType(0);
        }
//        PhotonIMClient.getInstance().forceUpLoad();
    ...
    public void init(Builder builder) {
        ...
        PhotonIMClient.getInstance().setInsertWithDrawMsg(true);
    }
    ...
    public interface BusinessListener {
        ...
        //获取room信息
        void onRoomInfoClick(Activity chatRoomActivity, String roomId, String rName);
        ...
        void leaveRoom(String rId, IChatRoomModel.ChatRoomListener listener);
    }
