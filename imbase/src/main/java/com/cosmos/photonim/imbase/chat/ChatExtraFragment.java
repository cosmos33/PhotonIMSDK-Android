...
public class ChatExtraFragment extends RvBaseFragment {
    ...
    private OnEtInputEvent onEtInputEvent;
    ...
    protected void initView(View view) {
        ...
        etInput.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                onEtInputEvent.beforeTextChanged(s,start,count,after);
            }

            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                onEtInputEvent.onTextChanged(s,start,before,count);
            }

            @Override
            public void afterTextChanged(Editable s) {
                onEtInputEvent.afterTextChanged(s);
...
//            chatExtraItemData.add(new ChatExtraItemData(R.drawable.capture,"自定义"));
...
//                        startActivityForResult(intent, Constants.REQUEST_IMAGE_CODE);
                        ...
                        FileActivity.start(getActivity());
                    } else if (position == 4) {
    ...
    public interface OnEtInputEvent{
    ...
    public void setEtInputEventListener(OnEtInputEvent onEtInputEvent){
        this.onEtInputEvent = onEtInputEvent;
    }
